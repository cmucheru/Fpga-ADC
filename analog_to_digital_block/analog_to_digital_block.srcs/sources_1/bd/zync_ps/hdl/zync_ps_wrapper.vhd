...
--Command     : generate_target zync_ps_wrapper.bd
--Design      : zync_ps_wrapper
...
architecture STRUCTURE of zync_ps_wrapper is
  component zync_ps is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component zync_ps;
begin
zync_ps_i: component zync_ps
     port map (
